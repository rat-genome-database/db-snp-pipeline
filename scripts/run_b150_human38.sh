# runs loading for dbSnp for human, build 150 for GRCh38.p7 on dev database
...
java -Dspring.config=../properties/default_db.xml \
   ...
   -jar DbSnpLoad.jar \
   -data_dir /data/dbSnp/dbSnp150_human38 \
   -map_key 38 \
   -build dbSnp150 \
   -with_clinical_significance \
   -group_label GRCh38.p7 2>&1 | tee b150_human38.log